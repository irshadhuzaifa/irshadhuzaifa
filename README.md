...
![Zustand](https://img.shields.io/badge/Zustand-000000?style=for-the-badge&logo=zoo&logoColor=white)
...
![AWS](https://img.shields.io/badge/AWS-232F3E?style=for-the-badge&logo=cloudsmith&logoColor=white)
...
### 🚀 Expertise
- ✅ Full-Stack Web Development (APIs, Backend, Frontend)
- ✅ Scalable AI/ML Pipelines and Data-Driven Apps
- ✅ Automation, Web Scraping, and ETL Systems
- ✅ REST APIs, DevOps, CI/CD, Dockerization
- ✅ Technical Documentation and Client Communication  

---

### 💡 Featured Projects
- **🌐 [Mettlesome Genius – Blogging Platform](https://www.mettlesomegenius.net/)** *(Flask, Jinja, MySQL, AWS-EC2)*  
  A modern blog platform with image upload, post management, user auth, and admin dashboard.  
